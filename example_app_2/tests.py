...
class ViewTests(TestCase):
    """
    Tests to ensure valid Example App 2 views.
    """
    @classmethod
    ...
    def test_index(self):
        response = self.client.get(reverse('example_app_2:index'))
    ...
    def test_category_create(self):
        response = self.client.get(reverse('example_app_2:category_create'))
        self.assertEqual(response.status_code, 200)
