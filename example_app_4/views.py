...
def topping_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse('example_app_4:topping_detail', args=(topping.id, )))
...
def pizza_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Render response for user.
            return HttpResponseRedirect(reverse('example_app_4:pizza_detail', args=(pizza.id, )))
